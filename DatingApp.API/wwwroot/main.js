...
module.exports = "<div *ngIf=\"registerMode == false\" class=\"container mt-5\">\n  <div style=\"text-align: center\">\n    <h1>Find your match</h1>\n    <p class=\"lead\">Come on in to view your matches... All you need to do is sign up!</p>\n    <div class=\"text-center\">\n      <button class=\"btn btn-primary btn-lg mr-2\" (click)=\"registerModeToggle()\">Register</button>\n      <button class=\"btn btn-info btn-lg\">Learn more</button>\n    </div>\n  </div>\n\n  <div class=\"container\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-4\">\n        <app-register (cancelRegister)=\"cancelRegisterMode($event)\"></app-register>\n      </div>\n    </div>\n  </div>\n</div>"
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.currentPhotoUrl.subscribe(function (url) { return _this.photoUrl = url; });
    };
...
/* harmony import */ var _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./resolvers/member-detail.resolver */ "./src/app/resolvers/member-detail.resolver.ts");
/* harmony import */ var _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./resolvers/member-list.resolver */ "./src/app/resolvers/member-list.resolver.ts");
...
/* harmony import */ var _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./resolvers/member-edit.resolver */ "./src/app/resolvers/member-edit.resolver.ts");
...
module.exports = __webpack_require__(/*! C:\Andrii\Projects\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
